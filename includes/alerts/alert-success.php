<div class="p-4 bg-success-50 border border-success-500 rounded-xl dark:border-success-500/30 dark:bg-success-500/15">
  <div class="flex items-start gap-3">
    ...
    <div>
      ...
      <a href="#" class="inline-block mt-3 text-sm font-medium text-gray-500 underline dark:text-gray-400">
        Learn more
      </a>
    </div>
  </div>
