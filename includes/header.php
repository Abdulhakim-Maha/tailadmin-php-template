    ...
    >
      <div class="2xsm:gap-3 flex items-center gap-2">
        ...
        >
          ...
          <div
            x-show="dropdownOpen"
            class="shadow-theme-lg dark:bg-gray-dark absolute -right-60 mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0 dark:border-gray-800"
          >
            <div
            ...
            <ul class="custom-scrollbar flex flex-1 flex-col overflow-y-auto">
              <li>
                <a
